...
export default function CandidateResearchProfile({ candidateId, coverageRevision }: { candidateId: string; coverageRevision?: number }) {
  ...
  return <ResearchPanel title={detail?.candidate.displayName ?? "Candidate research profile"} name="research-candidate-profile" description="Original research remains available across selection changes. A candidate identity is separate from a verified firm identity.">
