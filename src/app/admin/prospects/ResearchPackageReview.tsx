...
export default function ResearchPackageReview({ packageId, initialData }: { packageId: string; initialData?: ResearchPackageReviewView }) {
  ...
  return <div className="min-w-0 space-y-4" data-testid="research-package-review">
    ...
    <header data-ui-component-content="research-package-heading"><h1 className="w-full text-balance text-xl font-bold text-navy lg:text-2xl" data-ui-copy="heading">Review research package</h1><p className="mt-2 w-full text-balance text-sm text-black/60" data-ui-copy="supporting">Keep findings tied to their sources; review profile changes separately.</p></header>
