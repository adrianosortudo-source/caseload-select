...
export function DemoOperatorPanel({ view }: Props) {
  ...
  return (
    <div className="flex min-h-full flex-col bg-[#101A2A] text-white">
        ...
        {!state ? (
          ...
          <>
            ...
            {view.currentQuestion && (
              <section className="rounded-2xl border border-[#D4C3A7]/25 bg-[#D4C3A7]/10 p-5">
              ...
              {knownAnswers.length > 0 ? (
                <dl className="mt-4 space-y-3">
                  {knownAnswers.map(([key, value]) => (
                    <div key={key} className="border-l-2 border-emerald-300/50 pl-3">
            ...
            {report && (
              <>
                <section className="rounded-2xl border border-emerald-300/25 bg-emerald-300/[0.07] p-5">
