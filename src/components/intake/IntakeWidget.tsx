...
const TOUR_FIXTURES: Record<string, ScreenResponse[]> = {
  pi_strong: [
    ...
    // Finalize  -  Band A
    {
      ...
      response_text: "Thanks for the details. Your matter has been captured for the lawyer to review.",
      finalize: true, collect_identity: false,
      situation_summary: "Client was rear-ended on the 401 approximately three weeks ago at highway speed. A police report was filed. Ongoing medical treatment is in progress and significant work income was lost. Personal injury matter with police report on file and documented treatment.",
      cta: "Submitted for review. A lawyer will review what you shared and reach out directly if your matter fits the firm's practice.",
  ...
  emp_dismissal: [
    ...
    // Finalize  -  Band C
    {
      ...
      response_text: "Thanks for the details. Your matter has been captured for the lawyer to review.",
      finalize: true, collect_identity: false,
      situation_summary: "Client was terminated without stated cause after four years of employment and offered two weeks of severance (the statutory minimum). No written employment contract confirmed. Tenure: four years. Severance offered: statutory minimum.",
