...
- The Instagram callback verification token was replaced in the Vercel Production environment on 2026-09-06. The new value becomes active only after this PR's merged `main` deployment is Ready; update Meta's Instagram webhook verification value only after that deployment is verified.
