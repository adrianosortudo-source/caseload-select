...
const mainSecurityHeaders = [
  {
    ...
    value: [
      ...
      "connect-src 'self' http://localhost:8765 http://127.0.0.1:8765 https://*.supabase.co https://api.resend.com https://generativelanguage.googleapis.com https://openrouter.ai",
      "frame-src 'self' http://localhost:8765 http://127.0.0.1:8765",
